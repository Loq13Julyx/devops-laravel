                                ...
                                <tr>
                                    <td style="padding: 40px 48px 32px;">
                                        ...
                                        <p style="color:#6b4c30; font-size:15px; line-height:1.7; margin:0 0 16px 0;">
                                            Kami menerima permintaan untuk mengatur ulang password akun <strong>Cafe Bonanza</strong> Anda.
                                        </p>
                                            ...
                                            <tr>
                                                <td style="background-color:#fdf6ee; border-left:4px solid #8B5E3C; border-radius:8px; padding:16px 20px;">
                                                    ...
                                                    <p style="color:#6b4c30; font-size:13px; line-height:1.6; margin:0;">
                                                        Link reset password ini akan <strong>kedaluwarsa dalam 60 menit</strong>. Jika sudah lewat, silakan minta link baru dari halaman lupa password.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
